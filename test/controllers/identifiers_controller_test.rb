...
class IdentifiersControllerTest < ActionController::TestCase
  ...
  test "should create identifier" do
    assert_difference('Identifier.count') do
      post :create, identifier: { name: @identifier.name, provider: @identifier.provider, share_id: @identifier.share_id }
    end
  ...
  test "should update identifier" do
    patch :update, id: @identifier, identifier: { name: @identifier.name, provider: @identifier.provider, share_id: @identifier.share_id }
    assert_redirected_to identifier_path(assigns(:identifier))
  end
