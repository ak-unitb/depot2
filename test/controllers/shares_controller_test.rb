...
class SharesControllerTest < ActionController::TestCase
  ...
  test "should create share" do
    assert_difference('Share.count') do
      post :create, share: { currency: @share.currency, isin: @share.isin, name: @share.name, stock_exchange_id: @share.stock_exchange_id }
    end
  ...
  test "should update share" do
    patch :update, id: @share, share: { currency: @share.currency, isin: @share.isin, name: @share.name, stock_exchange_id: @share.stock_exchange_id }
    assert_redirected_to share_path(assigns(:share))
  end
