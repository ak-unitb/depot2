...
class StockExchangesControllerTest < ActionController::TestCase
  ...
  test "should create stock_exchange" do
    assert_difference('StockExchange.count') do
      post :create, stock_exchange: { closing_time: @stock_exchange.closing_time, location: @stock_exchange.location, name: @stock_exchange.name, timezone: @stock_exchange.timezone }
    end
  ...
  test "should update stock_exchange" do
    patch :update, id: @stock_exchange, stock_exchange: { closing_time: @stock_exchange.closing_time, location: @stock_exchange.location, name: @stock_exchange.name, timezone: @stock_exchange.timezone }
    assert_redirected_to stock_exchange_path(assigns(:stock_exchange))
  end
